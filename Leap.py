#have to have the leap program and developer installed on computer you are running the code from
...
# Python < 2.2 doesn't have 'property' and will give you alot of errors.
